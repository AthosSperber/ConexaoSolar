...
const BenefitCard: FC<BenefitCardProps> = ({ benefit }) => {
  ...
  return (
    <div className="group p-8 md:p-10 bg-emerald-50/60 hover:bg-emerald-50/80 dark:bg-gradient-to-br dark:from-gray-900/70 dark:to-emerald-950/20 dark:hover:to-emerald-950/30 rounded-2xl border-2 border-emerald-300/70 dark:border-emerald-900/50 hover:border-green-500 dark:hover:border-green-600 hover:shadow-xl dark:hover:shadow-green-900/20 transition-all duration-300 h-full flex flex-col">
