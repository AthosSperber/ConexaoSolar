...
const BenefitCard: FC<BenefitCardProps> = ({ benefit }) => {
  ...
  return (
    <div className="group p-8 md:p-10 bg-white dark:bg-gray-800/80 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-600 hover:shadow-xl dark:hover:shadow-green-900/20 transition-all duration-300 h-full flex flex-col">
