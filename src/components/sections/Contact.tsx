export default function Contact() {
  return (
    <section id="contact" className="bg-white px-4 py-10 text-center">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-xl font-bold text-gray-900 mb-3">Ainda ficou alguma dúvida?</h2>
        ...
        <p className="text-xs text-gray-500 mt-4">Atendimento rápido • Sem pressão • Sem obrigação</p>
      </div>
    </section>
  );
}
