    ...
    <section id="livre" className="scroll-snap-section bg-gradient-to-br from-purple-50 via-emerald-50/20 to-emerald-50/60 dark:from-gray-950 dark:via-purple-950/10 dark:to-gray-950">
      <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 md:order-1">
          <span className="product-tag text-purple-600 dark:text-purple-400 font-semibold text-sm uppercase tracking-wide">Conexão Livre</span>
          <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white mt-3 mb-4">Energia mais barata para empresas</h2>
          ...
          <ul className="space-y-3 mb-8 text-gray-700 dark:text-gray-300">
            ...
            <li className="flex items-start gap-3">
              <span className="text-purple-600 font-bold text-xl leading-none">✓</span>
              <span>Sem precisar investir em equipamentos</span>
            </li>
          </ul>
