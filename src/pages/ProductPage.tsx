...
export default function ProductPage() {
  ...
  const whatsappUrl = `https://wa.me/5519996693018?text=${encodeURIComponent(product.cta.whatsappMessage)}`;

  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero Section */}
      <section className="w-full py-16 md:py-24 lg:py-32 bg-gradient-to-br from-green-50 via-emerald-50/50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {product.benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-gray-50 hover:bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-600 transition-all duration-300 hover:shadow-lg"
              >
      ...
      <section className="w-full py-16 md:py-24 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 leading-tight">
              Como Funciona
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {product.howItWorks.map((step, index) => (
              <div
                key={index}
                className="flex gap-6 items-start bg-gray-50 hover:bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-600 transition-all duration-300"
              >
      ...
      {/* Final CTA Section */}
      <section className="w-full py-12 md:py-16 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
